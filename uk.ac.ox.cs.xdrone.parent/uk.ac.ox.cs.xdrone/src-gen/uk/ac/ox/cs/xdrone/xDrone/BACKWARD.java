 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.ox.cs.xdrone.xDrone.BACKWARD#getMilliseconds <em>Milliseconds</em>}</li>
 * </ul>
 *
 * @see uk.ac.ox.cs.xdrone.xDrone.XDronePackage#getBACKWARD()
 * @model
 * @generated
 */
public interface BACKWARD extends Command
{
   ...
   * @see uk.ac.ox.cs.xdrone.xDrone.XDronePackage#getBACKWARD_Milliseconds()
   * @model
   * @generated
   */
  int getMilliseconds();
  ...
  /**
   * Sets the value of the '{@link uk.ac.ox.cs.xdrone.xDrone.BACKWARD#getMilliseconds <em>Milliseconds</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
