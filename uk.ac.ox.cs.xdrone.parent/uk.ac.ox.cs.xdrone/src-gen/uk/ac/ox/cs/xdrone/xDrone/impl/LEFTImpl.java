 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.ox.cs.xdrone.xDrone.impl.LEFTImpl#getMilliseconds <em>Milliseconds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LEFTImpl extends CommandImpl implements LEFT
{
  ...
  public void setMilliseconds(int newMilliseconds)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDronePackage.LEFT__MILLISECONDS, oldMilliseconds, milliseconds));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XDronePackage.LEFT__MILLISECONDS:
