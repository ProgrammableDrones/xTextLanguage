 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.ox.cs.xdrone.xDrone.impl.DOWNImpl#getMilliseconds <em>Milliseconds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DOWNImpl extends CommandImpl implements DOWN
{
  ...
  public void setMilliseconds(int newMilliseconds)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDronePackage.DOWN__MILLISECONDS, oldMilliseconds, milliseconds));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XDronePackage.DOWN__MILLISECONDS:
