 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.ox.cs.xdrone.xDrone.impl.UPImpl#getMilliseconds <em>Milliseconds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UPImpl extends CommandImpl implements UP
{
  ...
  public void setMilliseconds(int newMilliseconds)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDronePackage.UP__MILLISECONDS, oldMilliseconds, milliseconds));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XDronePackage.UP__MILLISECONDS:
