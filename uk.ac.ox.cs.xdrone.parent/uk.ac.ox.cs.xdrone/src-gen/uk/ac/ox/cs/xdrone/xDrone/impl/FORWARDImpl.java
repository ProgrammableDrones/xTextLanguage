 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.ox.cs.xdrone.xDrone.impl.FORWARDImpl#getMilliseconds <em>Milliseconds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FORWARDImpl extends CommandImpl implements FORWARD
{
  ...
  public void setMilliseconds(int newMilliseconds)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDronePackage.FORWARD__MILLISECONDS, oldMilliseconds, milliseconds));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XDronePackage.FORWARD__MILLISECONDS:
