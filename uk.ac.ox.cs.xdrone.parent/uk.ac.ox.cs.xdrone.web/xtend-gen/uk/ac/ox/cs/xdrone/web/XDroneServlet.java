...
import uk.ac.ox.cs.xdrone.web.XDroneWebSetup;
...
public class XDroneServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      XDroneWebSetup _xDroneWebSetup = new XDroneWebSetup(executorServiceProvider);
      _xDroneWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
